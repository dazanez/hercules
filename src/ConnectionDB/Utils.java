...
public class Utils {
    ...
    public static List<Map<String, String>> resultSetToList(ResultSet rs, String[] columns) throws SQLException {
        ...
        columns = (columns == null || Arrays.equals(columns, new String[]{})) ? getColumnsNames(rs.getMetaData()) : columns; // Antes mostraba las columnas que se registraban en una lista, pero eso se puede definir en la consulta
